**Follow class 04 step to create new project with poetry**
...
Add library to if uvicorn server is not working giving you error from server side 

```bash
poetry add unicorn[standard]
```
